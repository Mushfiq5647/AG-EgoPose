...
For testing:
`python test.py --encoder_path ./utils/kinect_trained_ckpt_final/encoder-20-66.ckpt --decoder_path ./utils/kinect_trained_ckpt_final/decoder-20-66.ckpt --test_annotation_path ./vocab/test_annotation.pkl`
