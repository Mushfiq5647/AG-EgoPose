...
hroot = 'you2me_ds_release_cmu/cmu'
import os
...
def create_homography_sequence_and_save(num_frames, input_folder, output_folder, sequence_length=15,
    ...
    for t in range(num_frames):
        ...
        output_file_path = os.path.join(output_folder, f"h{t}_extended.txt")
...
# # Example usage
# input_folder = "you2me_ds_release_cmu/cmu/11-hand2/features/homography/"  # Directory containing h0.txt, h1.txt, ..., hn.txt
# output_folder = "you2me_ds_release_cmu/cmu/11-hand2/features/extend_homography/"
# num_frames = 3602  # Total number of frames to process
#
...
# Example usage
directory = "you2me_ds_release_cmu/cmu/3-catch3/features/homography/"  # Replace with your directory path
