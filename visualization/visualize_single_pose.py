    ...
    with torch.no_grad():
        ...
        if args.gt_pickle_path is not None and os.path.exists(args.gt_pickle_path):
            ...
            with open(args.gt_pickle_path, 'rb') as f:
                data = pickle.load(f)
                print(f'Loaded {len(data)} images from {args.gt_pickle_path}')
...
if __name__ == '__main__':
    ...
    # Input image
    # parser.add_argument('--image_path', type=str, default ='/data/My_Backup/Dataset/SceneEgo_test/jian2/imgs/img_000609.jpg')
    ...
    parser.add_argument('--image_path', type=str, default ='/data/My_Backup/Dataset/EgoPW_dataset/EgoPW_original/kripa_new/out/imgs/img_000155.jpg')
    parser.add_argument('--gt_pickle_path', type=str, default='/data/My_Backup/Dataset/EgoPW_dataset/EgoPW_original/kripa_new/out/pseudo_gt.pkl', help='Path to pickle file with ground truth poses')
