...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--model', type=str, default='unrealego_autoencoder',
        ...
        ### dataset parameters ###
        self.parser.add_argument('--data_dir', type=str, default="/data/My_Backup/UnrealEgo/scripts/data/UnrealEgoData",
