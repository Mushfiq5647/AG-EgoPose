...
def main(args):
    ...
    total_samples = 0
    with torch.no_grad():
        for i, (images, gt_egoposes, homography, lengths) in enumerate(data_loader):
...
if __name__ == '__main__':
    ...
    # Directories
    parser.add_argument('--image_dir', type=str, default='D:/Dataset/EgoPW_dataset/EgoPW_dataset_release',
                        help='directory for resized images')
    parser.add_argument('--h_dir', type=str, default='D:/Dataset/EgoPW_dataset/EgoPW_dataset_release',
                        help='directory for resized images')
    parser.add_argument('--openpose_dir', type=str, default='D:/Dataset/EgoPW_dataset/EgoPW_dataset_release',
                        help='directory for resized images')
    # Model parameters
